...
TITLES = {
    ...
    'charge_unknown': 'Machines with no battery charging data'}
...
MAX_CHARGE_Q = Q(pluginscriptsubmission__pluginscriptrow__pluginscript_name='MaxCapacity')
DESIGN_CHARGE_Q = Q(pluginscriptsubmission__pluginscriptrow__pluginscript_name='DesignCapacity')
LAPTOPS_Q = Q(machine_model__contains='Book')


class BatteryReport(sal.plugin.ReportPlugin):
